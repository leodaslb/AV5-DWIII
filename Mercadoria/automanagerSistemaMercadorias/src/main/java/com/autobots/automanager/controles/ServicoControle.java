...
public class ServicoControle {
    ...
    public ResponseEntity<List<ServicoResDto>> obterServicosPorEmpresa(@PathVariable Long empresaId) {
        List<ServicoResDto> dto = servicoServico.listarPorEmpresa(empresaId);
        if (dto.isEmpty()) {
    ...
    public ResponseEntity<ServicoResDto> criarServico(
